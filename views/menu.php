<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">AEDI</a>
        </div>

        <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li>
                    <a href="/"><span class="glyphicon glyphicon-home white" aria-hidden="true"></span> Accueil</a>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/etudiants/evenements">Présentation</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/entreprises/RIFs">Rencontres IF</a></li>
                        <li><a href="/entreprises/entretiens">Simulations d'entretiens</a></li>
                        <li><a href="/entreprises/conferences">Conférences</a></li>
                        ...
                        <li><a href="/entreprises/parrainage">Devenir parrain de promotion</a></li>
                    </ul>
                </li>
                <li class=""><a href="/apropos"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> A propos</a></li>
                <li class=""><a href="/contact"><span class="glyphicon glyphicon-envelope white" aria-hidden="true"></span> Contact</a></li>
            </ul>
        </div>
    </div>
</div>
