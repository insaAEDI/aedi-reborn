...
<div id="accueil">
	...
	<div class="row" style="text-align:center;">
		...
		<p class="span3">
		    <a href="http://hardis.fr" title="Hardis - Parrain Promo 2016"><img class="adapt-width" span=3 scale=0.75 max=200 src="./commun/img/parrains_caroussel/hardis.png" alt="Hardis"></a>
		</p>
		<p class="span2">
			<a href="http://www.bull.fr/" title="Bull - Parrain Promo 2017"><img class="adapt-width" span=3 scale=0.5 max=200 src="./commun/img/parrains_caroussel/bull.png" alt="Bull"></a>
		</p>
        </div>
<!--<div class="row" style="text-align:center;">
