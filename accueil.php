 ...
 * ---------------------
 * Page d'accueil avec une description générale, les principaux sponsors, ... UNE PUTAIN DE LICORNE, SPECE D'ABRUTIS
 */
?>
...
<div id="accueil">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="img-thumbnail" src="commun/img/aedi_ban.png" style="margin-bottom: 10px;" alt="AEDI"/>
                <div class="well">
