                ...
                <div class="tab-pane active" id="divertissements">
                    ...
                    <div class="well">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="thumbnail">
                                    <img src="evenements/img/inte.jpg" title="Sortie ensoleillée lors de l'Intégration." />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="thumbnail">
                                    <img src="evenements/img/rdd.jpg" title="La Remise des Diplômes, plein d'émotions !" />
                                </div>
                            </div>
                        </div>
                    </div>
